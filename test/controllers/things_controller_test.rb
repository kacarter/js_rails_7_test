...
class ThingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create thing" do
    assert_difference("Thing.count") do
      post things_url, params: { thing: { active: @thing.active, expiration_date: @thing.expiration_date, name: @thing.name } }
    end
  ...
  test "should update thing" do
    patch thing_url(@thing), params: { thing: { active: @thing.active, expiration_date: @thing.expiration_date, name: @thing.name } }
